...
const GoogleSheetsConnector = ({ userProfile, refreshProfile }: GoogleSheetsConnectorProps) => {
    ...
    useEffect(() => {
        if (userProfile?.sheet_id) {
            setSheetUrl(`https://docs.google.com/spreadsheets/d/${userProfile.sheet_id}`);
            setIsConnected(true);
        } else {
            setSheetUrl("");
    ...
    const handleConnect = async () => {
        ...
        try {
            const googleSheetUpdateUrl = process.env.NEXT_PUBLIC_GOOGLE_SHEET_UPDATE_URL;
            ...
            if (!response || response.status !== 200) {
                ...
                throw new Error(errorData.message || "Failed to connect to Google Sheet");
            }
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <ul className="text-sm text-blue-700 space-y-1">
                                        <li>• Use the Email Fetcher to scan for job application updates</li>
